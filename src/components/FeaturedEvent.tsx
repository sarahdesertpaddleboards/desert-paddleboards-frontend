...
/**
 * Highlights the soonest upcoming FEATURED EVENT (a static entry that books
 * through FareHarbor, e.g. the Witches Regatta). Surfaced regardless of how far
 * out the date is — so a big annual event isn't buried at the bottom of a
 * date-sorted list. Renders nothing if there's no upcoming featured event.
 */
